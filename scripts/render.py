...
L = {
    "ru": {
        ...
        "hab": ["прерываний на 100 реплик",
                ...
                "достижений открыто"],
        "setup": ["вход в Hermes Agent", "план-режим", "версий Hermes Agent за период",
                  "самая дорогая сессия"],
        "activations": "%d включений", "tokens_of": "«%s» — %s токенов",
        "ep": {"hermes-agent": "Hermes Agent", "cli": "терминал", "vscode": "VS Code"},
        "models": {"opus": "Опус", "fable": "Фейбл", "sonnet": "Сонет", "haiku": "Хайку"},
    ...
    "en": {
        ...
        "setup": ["Hermes Agent entrypoint", "plan mode", "Hermes Agent versions in period",
                  "most expensive session"],
        "activations": "%d activations", "tokens_of": "“%s” — %s tokens",
        "ep": {"hermes-agent": "Hermes Agent", "cli": "terminal", "vscode": "VS Code"},
