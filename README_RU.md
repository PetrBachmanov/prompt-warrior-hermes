...
*Это форк оригинального репозитория [timoncool/prompt-warrior](https://github.com/timoncool/prompt-warrior), созданного для Claude Code. Данная версия была адаптирована для поддержки Hermes Agent.*
